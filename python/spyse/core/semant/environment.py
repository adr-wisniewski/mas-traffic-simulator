...
#class Model(object, Pyro.core.ObjBase):
class Model(Pyro.core.ObjBase):
...
#class Model(threading.Thread):
    ...
    def __init__(self):
        ...
        if dist == Dist.CENTRAL_SERVER:
            ...
            self.__model_server = Pyro.core.getProxyForURI('PYRONAME://' + Model.SERVER_PYRONAME)
...
#class Controller(object, Pyro.core.ObjBase  ):
class Controller(Pyro.core.ObjBase  ):
    def __init__(self, model):
        ...
        #elif dist == Dist.CENTRAL_CLIENT:
        #    self.__model_server = Pyro.core.getProxyForURI("PYRONAME://controller-server")
