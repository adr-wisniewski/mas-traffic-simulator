...
PYUIC4 = os.path.join(PATH, "pyside-uic")
PYRCC4 = os.path.join(PATH, "pyside-rcc")
PYLUPDATE4 = os.path.join(PATH, "pyside-lupdate")
LRELEASE = "lrelease"
...
def usage():
    print """usage: mkpyqt.py [options] [_path]
...
hard-code the _path; the variables with the tool paths are near the top
of the file.
...
# 1.0.2 Changed default _path on Windows to match PyQt 4.4
